...
This includes:
- README.md files
- Bug report documentation files
- Debugging summary files
- Error analysis documents
- Any .md, .txt, .rst, .adoc, or similar documentation formats

**What you CAN do**:
- Provide debugging analysis directly in your response to the user
...
- Create markdown bug reports or debugging summaries as files
